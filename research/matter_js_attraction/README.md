...
- Each mover is attracted with force proportional to 1/r² (with distance constrained to [5, 25]).
- Press `s` to save a screenshot to `research/matter_js_attraction/screenshots/`.
