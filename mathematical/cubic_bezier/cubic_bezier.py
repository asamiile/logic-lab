...
def setup() -> None:
    ...
    ctr = [(0, 0), (py5.width, 0), (py5.width, py5.height), (0, py5.height)]
    py5.no_fill()
...
def draw() -> None:
    ...
    if itr > STEP:
        py5.stroke(0, 0, 0)
        py5.stroke_weight(1)
        py5.bezier(*[coord for point in ctr for coord in point])
        py5.no_loop()
...
def key_pressed() -> None:
    if py5.key == "s":
        py5.save_frame(str(SCREENSHOT_DIR / "cubic_bezier_####.png"))
