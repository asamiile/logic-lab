...
def get_args():
    ...
    parser.add_argument(
        '-n', '--name',
        type=str, default='locomotion_me_neat_run',
    ...
    parser.add_argument(
        ...
        help='MAP-Elites population size (default: 100)'
    )
    parser.add_argument(
        '-b', '--batch-size',
        type=int, default=50,
    ...
    parser.add_argument(
        '--bd-1',
        type=str, default='forward_speed',
        choices=['forward_speed', 'lateral_stability', 'body_tilt', 'joint_activity', 'step_frequency'],
        help='first behavioral descriptor axis (default: forward_speed)'
    )
    parser.add_argument(
        '--bd-2',
        type=str, default='joint_activity',
        choices=['forward_speed', 'lateral_stability', 'body_tilt', 'joint_activity', 'step_frequency'],
