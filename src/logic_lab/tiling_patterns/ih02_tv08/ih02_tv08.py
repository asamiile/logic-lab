...
def draw() -> None:
    ...
    draw_tiling(lattice, lambda i, j: draw_bezier_poly(vertices, "ih02", tile_colors[i][j]), True)
    draw_status()
...
def draw_status() -> None:
    ...
    py5.text("A/Z hor  D/X ver", 10, 36)
...
def key_pressed() -> None:
    ...
    if key == "a":
        ...
        py5.save_frame(str(SCREENSHOT_DIR / "ih02_tv08_####.png"))
