...
def get_args():
    parser = argparse.ArgumentParser(description="Circuit NEAT experiment")

    parser.add_argument("-n", "--name", type=str, help='experiment name (default: "{task}")')
    parser.add_argument(
        "-t",
        "--task",
        default="xor",
    ...
    parser.add_argument(
        "-p", "--pop-size", default=150, type=int, help="population size of NEAT (default: 150)"
    )
    parser.add_argument(
        "-g", "--generation", default=300, type=int, help="iterations of NEAT (default: 300)"
    )
...
def get_figure_args():
    parser = argparse.ArgumentParser(description="make circuit figures")

    parser.add_argument("name", type=str, help="nam of experiment for making figures")
    parser.add_argument(
        "-s",
        "--specified",
        type=int,
