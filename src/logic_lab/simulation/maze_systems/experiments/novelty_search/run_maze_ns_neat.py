...
from arguments.maze_ns_neat import get_args
...
def main():
    ...
    save_path = os.path.join(CURR_DIR, "out", "maze_ns_neat", args.name)
    ...
    config_out_file = os.path.join(save_path, "maze_ns_neat.cfg")
