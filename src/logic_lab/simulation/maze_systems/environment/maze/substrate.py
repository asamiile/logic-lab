...
class Substrate:
    ...
    def make_substrate(self):
        ...
        input_nodes = [
            {
                "name": "sensor270",
                "dims": {
                    "x": np.cos(270 / 180 * np.pi),
                    "y": np.sin(270 / 180 * np.pi),
                    "d": 1,
                    "sensor": 1,
                },
                "vector": None,
            },
            {
                "name": "sensor315",
                "dims": {
                    "x": np.cos(315 / 180 * np.pi),
                    "y": np.sin(315 / 180 * np.pi),
                    "d": 1,
                    "sensor": 1,
                },
                "vector": None,
            },
            {
                "name": "sensor0",
                "dims": {
                    "x": np.cos(0 / 180 * np.pi),
                    "y": np.sin(0 / 180 * np.pi),
                    "d": 1,
                    "sensor": 1,
                },
                "vector": None,
            },
            {
                "name": "sensor45",
                "dims": {
                    "x": np.cos(45 / 180 * np.pi),
                    "y": np.sin(45 / 180 * np.pi),
                    "d": 1,
                    "sensor": 1,
                },
                "vector": None,
            },
            {
                "name": "sensor90",
                "dims": {
                    "x": np.cos(90 / 180 * np.pi),
                    "y": np.sin(90 / 180 * np.pi),
                    "d": 1,
                    "sensor": 1,
                },
                "vector": None,
            },
            {
                "name": "sensor180",
                "dims": {
                    "x": np.cos(180 / 180 * np.pi),
                    "y": np.sin(180 / 180 * np.pi),
                    "d": 1,
                    "sensor": 1,
                },
                "vector": None,
        ...
        output_nodes = [
            {"name": "actuator_rotation", "dims": {"rotate": 1}, "vector": None},
            {"name": "actuator_speed", "dims": {"spped": 1}, "vector": None},
        ]
        ...
        self.dims = list(
            set().union(
                *(
                    sum(
                        [
                            [set(node["dims"].keys()) for node in nodes]
        ...
        self.cppn_dims = list(map(lambda z: z + "1", self.dims)) + list(
            map(lambda z: z + "2", self.dims)
        )
        ...
        hidden_nodes = [
            {
                "name": f"{name}60",
                "dims": {
                    "x": np.cos(60 / 180 * np.pi) / 2,
                    "y": np.sin(60 / 180 * np.pi) / 2,
                    "d": 0.5,
                },
                "vector": None,
            },
            {
                "name": f"{name}180",
                "dims": {
                    "x": np.cos(180 / 180 * np.pi) / 2,
                    "y": np.sin(180 / 180 * np.pi) / 2,
                    "d": 0.5,
                },
                "vector": None,
            },
            {
                "name": f"{name}300",
                "dims": {
                    "x": np.cos(300 / 180 * np.pi) / 2,
                    "y": np.sin(300 / 180 * np.pi) / 2,
                    "d": 0.5,
                },
                "vector": None,
            },
        ...
        for layer_in, layer_out in layer_pairs:
            for node_in in self.nodes[layer_in]:
                for node_out in self.nodes[layer_out]:
                    connections[(node_in["name"], node_out["name"])] = np.hstack(
                        (node_in["vector"], node_out["vector"])
                    )
