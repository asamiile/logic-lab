...
def load_best_genome(experiment_dir):
    ...
    if best_genome is None:
        raise RuntimeError(f'No valid genomes found in genome directory')
...
def visualize_controller(genome, task, episodes=3, max_steps=1000, render_mode='rgb_array', config=None):
