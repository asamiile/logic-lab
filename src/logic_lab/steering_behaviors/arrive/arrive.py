...
class Vehicle:
    def __init__(self, x: float, y: float) -> None:
        ...
        self.velocity = py5.Py5Vector(0, -2)
    ...
    def arrive(self, target: py5.Py5Vector) -> None:
        ...
        if distance == 0:
            ...
            speed = py5.remap(distance, 0, 100, 0, self.max_speed)
...
def mouse_pressed() -> None:
    py5.save_frame(str(SCREENSHOT_DIR / "arrive_####.png"))
