...
- Press `d` to toggle debug visualization (predicted position, normal point, target).
- Click to add a new vehicle.
- Press `s` to save a screenshot to `steering_behaviors/crowd_path_following/screenshots/`.
