...
def setup() -> None:
    py5.size(640, 240)
    emitters.append(Emitter(100, 60))
    emitters.append(Emitter(200, 30))
    emitters.append(Emitter(350, 90))
    emitters.append(Emitter(540, 50))
...
def key_pressed() -> None:
    if py5.key == "s":
        py5.save_frame(str(SCREENSHOT_DIR / "emitters_2_####.png"))
