...
- `Confetti` inherits particle motion and overrides only its display.
- Press `s` to save a screenshot to `physics/particle_system_inheritance_polymorphism/screenshots/`.
